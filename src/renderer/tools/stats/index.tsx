...
export default class StatsPlugin extends AbstractEditorPlugin<IStatsState> {
    ...
    public render(): React.ReactNode {
        ...
        const durations = (
            <div>
                <Divider style={{ backgroundColor: "dimgrey" }}>GPU</Divider>
                ...
                <Divider style={{ backgroundColor: "dimgrey" }}>Scene</Divider>
                ...
                <Divider style={{ backgroundColor: "dimgrey" }}>Elements</Divider>
