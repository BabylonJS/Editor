...
export class SubGraph extends (<any> LiteGraph.Nodes.Subgraph) {
...
export class GraphInput extends (<any> LiteGraph.Nodes.GraphInput) {
...
export class GraphOutput extends (<any> LiteGraph.Nodes.GraphOutput) {
