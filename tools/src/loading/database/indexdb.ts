 ...
 */
export async function openDatabase(name: string, upgradeNeeded: (database: IDBDatabase) => void): Promise<IDBDatabase> {
 ...
 */
export function getFromDatabase<T>(database: IDBDatabase, storeName: string, key: string): Promise<T | null> {
 ...
 */
export async function putInDatabase<T>(database: IDBDatabase, storeName: string, data: T): Promise<void> {
