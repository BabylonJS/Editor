 ...
 */
export function parseConstantValue(value: Value): number {
 ...
 */
export function parseIntervalValue(value: Value): { min: number; max: number } {
	...
	const constant = parseConstantValue(value);
 ...
 * - [r, g, b, a] (array)
 */
export function parseConstantColor(value: Color): Color4 {
 ...
 */
export function parseValue(value: Value, normalizedTime?: number): number {
	...
	if (value.type === "PiecewiseBezier") {
		...
		return evaluatePiecewiseBezier(value, t);
	}
 ...
 */
function evaluatePiecewiseBezier(bezier: IPiecewiseBezier, t: number): number {
 ...
 */
export function parseGradientColorKeys(keys: IGradientKey[]): ColorGradient[] {
 ...
 */
export function parseGradientAlphaKeys(keys: IGradientKey[]): { gradient: number; factor: number }[] {
