...
export class EmitterFactory {
	 ...
	 */
	private _createPointEmitter(particleSystem: EffectParticleSystem, direction: Vector3, minDirection: Vector3): void {
	 ...
	 */
	private _createDefaultPointEmitter(particleSystem: EffectParticleSystem, rotationMatrix: Matrix | null): void {
		const defaultDir = new Vector3(0, 1, 0);
		const rotatedDir = this._applyRotationToDirection(defaultDir, rotationMatrix);
