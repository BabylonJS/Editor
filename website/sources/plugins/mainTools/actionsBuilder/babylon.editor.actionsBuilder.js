            ...
            */
            ...
            ActionsBuilder.prototype._configureUI = function () {
                ...
                for (var i = BABYLON.ActionManager.NothingTrigger; i <= BABYLON.ActionManager.OnKeyUpTrigger; i++) {
                    this._triggersList.addRecord({ recid: i, name: BABYLON.ActionManager.GetTriggerName(i), w2ui: { style: "background-color: rgb(133, 154, 185)" } });
                }
                ...
                for (var i = 0; i < this._actionsClasses.length; i++) {
                    this._actionsList.addRecord({ recid: i, name: this._actionsClasses[i].name, w2ui: { style: "background-color: rgb(182, 185, 132)" } });
                }
...
//# sourceMappingURL=babylon.editor.actionsBuilder.js.map
