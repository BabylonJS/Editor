            ...
            */
            ...
            PostProcessesTool.prototype.update = function () {
                ...
                if (EDITOR.SceneFactory.DefaultPipeline) {
                    ...
                    imgProcessingFolder.add(EDITOR.SceneFactory.DefaultPipeline.imageProcessing, "vignetteCameraFov").name("Vignette Camera Fov");
                    imgProcessingFolder.add(EDITOR.SceneFactory.DefaultPipeline.imageProcessing, "vignetteCentreX").min(-10).max(10).step(0.01).name("Vignette Centre X");
                    imgProcessingFolder.add(EDITOR.SceneFactory.DefaultPipeline.imageProcessing, "vignetteCentreY").min(-10).max(10).step(0.01).name("Vignette Centre Y");
                    imgProcessingFolder.add(EDITOR.SceneFactory.DefaultPipeline.imageProcessing, "vignetteStretch").step(0.01).name("Vignette Stretch");
                    imgProcessingFolder.add(EDITOR.SceneFactory.DefaultPipeline.imageProcessing, "colorCurvesEnabled").name("Color Curves");
                    imgProcessingFolder.add(EDITOR.SceneFactory.DefaultPipeline.imageProcessing, "contrast").name("Contrast");
                    imgProcessingFolder.add(EDITOR.SceneFactory.DefaultPipeline.imageProcessing, "exposure").name("Exposure");
                    this._defaultVignetteMultiply = EDITOR.SceneFactory.DefaultPipeline.imageProcessing.vignetteBlendMode === BABYLON.ImageProcessingConfiguration.VIGNETTEMODE_MULTIPLY;
                    imgProcessingFolder.add(this, "_defaultVignetteMultiply").name("Vignette Multiply").onChange(function (result) {
                        var blendMode = result ? BABYLON.ImageProcessingConfiguration.VIGNETTEMODE_MULTIPLY : BABYLON.ImageProcessingConfiguration.VIGNETTEMODE_OPAQUE;
                ...
                if (EDITOR.SceneFactory.StandardPipeline) {
                    ...
                    vlsFolder.add(EDITOR.SceneFactory.StandardPipeline, "volumetricLightStepsCount").min(0).max(100).step(1).name("Steps count");
                    vlsFolder.open();
                    ...
                    dofFolder.add(EDITOR.SceneFactory.StandardPipeline, "depthOfFieldBlurWidth").min(0).max(512).name("Blur Width");
                    dofFolder.open();
