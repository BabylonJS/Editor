			...
			<div className="flex flex-col gap-10 lg:max-w-3xl 2xl:max-w-6xl mx-auto pt-32">
				...
				<Fade triggerOnce>
					<div className="flex flex-col gap-4">
						...
						<img alt="" src="/documentation/basics/creating-project/dashboard.png" />
						...
						<img alt="" src="/documentation/basics/creating-project/creating-project.png" />
						...
						<img alt="" src="/documentation/basics/creating-project/project-created.png" />

						<div>Now, to open and edit the project, just double-click the project in the dashboard and the editor will open.</div>

						<img alt="" src="/documentation/basics/creating-project/project-opened.png" />
