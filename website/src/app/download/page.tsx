			...
			<div className="flex flex-col gap-10 max-w-4xl mx-auto pt-32">
				<Fade cascade damping={0.1} triggerOnce className="w-full">
					...
					<DownloadVersionComponent
						version="v5.5.1"
						windowsx64Link="https://babylonjs-editor.fra1.cdn.digitaloceanspaces.com/updates/BabylonJS%20Editor%20Setup%205.5.1.exe"
						macArm64Link="https://babylonjs-editor.fra1.cdn.digitaloceanspaces.com/updates/BabylonJS%20Editor-5.5.1-arm64.dmg"
						macIntelLink="https://babylonjs-editor.fra1.cdn.digitaloceanspaces.com/updates/x64/BabylonJS%20Editor-5.5.1.dmg"
						linuxx64Link="https://babylonjs-editor.fra1.cdn.digitaloceanspaces.com/updates/BabylonJS%20Editor-5.5.1.AppImage"
						linuxArm64Link="https://babylonjs-editor.fra1.cdn.digitaloceanspaces.com/updates/BabylonJS%20Editor-5.5.1-arm64.AppImage"
					/>
