    ...
    return (
        <ReactLenis root>
            ...
            <main className="min-w-screen min-h-screen landing text-black dark:text-white">
                <div className={`fixed top-0 left-0 w-screen h-screen z-0 ${section2Visible ? "" : "blur-xl scale-125 opacity-50 brightness-0"} transition-all duration-1000 ease-in-out`}>
                    <RendererComponent />
                </div>
                ...
                <div className="flex flex-col justify-between items-center gap-5 w-screen h-screen max-w-7xl pt-48 px-5 mx-auto">
                    <Fade cascade damping={0.1} triggerOnce direction="up">
                        <Fade>
                            <div className="text-4xl md:text-7xl lg:text-9xl font-semibold font-sans">
                                Babylon.js Editor
                            </div>
                        </Fade>

                        <Fade>
                            <div className="text-xl md:text-3xl text-center max-w-64 md:max-w-max font-semibold">
                                Focus more on <b className="text-[rgb(73,202,146)]">creating</b> and less on <b className="text-[rgb(218,151,55)]">coding</b>.
                            </div>
                        </Fade>

                        <Fade>
                            <div className="text-center text-sm lg:text-lg max-w-3xl mx-auto">
