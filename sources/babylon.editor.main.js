    ...
    (function (EDITOR) {
        var EditorMain = (function () {
            ...
            EditorMain.prototype._createUI = function () {
                ...
                var mainPanel = this.playLayouts.createPanel("BABYLON-EDITOR-MAIN-MAIN-PANEL", "main", undefined, undefined).setContent("<canvas id=\"BABYLON-EDITOR-MAIN-CANVAS\"></canvas>" +
