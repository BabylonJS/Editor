module BABYLON.EDITOR {
    ...
    export class SceneFactory {
        ...
        */
        ...
        static AddLensFlare(core: EditorCore, chooseEmitter: boolean = true, emitter?: any): void {
            // Pick emitter
            if (chooseEmitter) {
                var picker = new ObjectPicker(core);
                picker.objectLists.push(core.currentScene.meshes);
                ...
                picker.onObjectPicked = (names: string[]) => {
                    ...
                    if (emitter) {
                        ...
                        var flare0 = new BABYLON.LensFlare(0.2, 0, new BABYLON.Color3(1, 1, 1), null, system);
                        var flare1 = new BABYLON.LensFlare(0.5, 0.2, new BABYLON.Color3(0.5, 0.5, 1), null, system);
                        var flare2 = new BABYLON.LensFlare(0.2, 1.0, new BABYLON.Color3(1, 1, 1), null, system);
                        var flare3 = new BABYLON.LensFlare(0.4, 0.4, new BABYLON.Color3(1, 0.5, 1), null, system);
                        var flare4 = new BABYLON.LensFlare(0.1, 0.6, new BABYLON.Color3(1, 1, 1), null, system);
                        var flare5 = new BABYLON.LensFlare(0.3, 0.8, new BABYLON.Color3(1, 1, 1), null, system);

                        for (var i = 0; i < system.lensFlares.length; i++)
                            system.lensFlares[i].texture = texture;
                    }
