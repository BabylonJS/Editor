...
import { ColorGradient } from "../../../Misc/gradients";
...
import type { VFXPiecewiseBezier } from "../types/values";

/**
 * Parser for Three.js value types (ConstantValue, IntervalValue, Gradient, etc.)
 */
export class VFXValueParser implements IVFXValueParser {
    /**
     * Parse a constant value
     */
    public parseConstantValue(value: VFXValue): number {
     ...
     */
    public parseIntervalValue(value: VFXValue): { min: number; max: number } {
     ...
     */
    public parseConstantColor(value: VFXColor): Color4 {
     ...
     */
    public parseGradientColorKeys(keys: VFXGradientKey[]): ColorGradient[] {
     ...
     */
    public parseGradientAlphaKeys(keys: VFXGradientKey[]): { gradient: number; factor: number }[] {
     ...
     */
    public parseValue(value: VFXValue, normalizedTime?: number): number {
     ...
     */
    private _evaluatePiecewiseBezier(bezier: VFXPiecewiseBezier, t: number): number {
