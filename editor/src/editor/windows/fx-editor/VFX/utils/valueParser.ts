 ...
 */
export class VFXValueUtils {
	/**
	 * Parse a constant value
	 */
	public static parseConstantValue(value: VFXValue): number {
	 ...
	 */
	public static parseIntervalValue(value: VFXValue): { min: number; max: number } {
	 ...
	 */
	public static parseConstantColor(value: VFXColor): Color4 {
	 ...
	 */
	public static parseValue(value: VFXValue, normalizedTime?: number): number {
