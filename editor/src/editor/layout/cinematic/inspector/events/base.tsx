...
import { CinematicEditorEventKeyInspector } from "./event";
...
export interface ICinematicEditorBaseEventKeyInspectorProps {
	cinematicEditor: CinematicEditor;
	cinematicKey: ICinematicKeyEvent;
	track: ICinematicTrack;
}

export function CinematicEditorBaseEventKeyInspector(props: ICinematicEditorBaseEventKeyInspectorProps) {
	const o = {
	...
	return (
		<EditorInspectorSectionField title="Event">
			...
			{props.cinematicKey.data?.type === "event" && <CinematicEditorEventKeyInspector cinematicKey={props.cinematicKey} />}
