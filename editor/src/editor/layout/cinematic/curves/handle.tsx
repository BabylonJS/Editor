		...
		document.body.addEventListener(
			...
			(mouseMoveListener = (ev) => {
				...
				const tangents = convertBezierToTangents({
					p0: [getKeyFrame(props.cinematicKey), getEditablePropertyValue(props.editableProperty) * props.yScale],
					p1: [getKeyFrame(props.nextCinematicKey), getEditablePropertyValue(props.nextEditableProperty) * props.yScale],
					c1: [c1[0], props.height * 0.5 - c1[1]],
					c2: [c2[0], props.height * 0.5 - c2[1]],
				});
