...
export function CinematicEditorPropertyCurve(props: ICinematicEditorPropertyCubeProps) {
	...
	const { p0, p1, c1, c2 } = convertKeysToBezier({
		...
		outTangent: props.editableTangentProperty ? getEditablePropertyValue(props.editableTangentProperty) : 0,
		inTangent: props.nextEditableTangentProperty ? getEditablePropertyValue(props.nextEditableTangentProperty) : 0,
	});
