...
export interface ICinematicEditorTrackerState {
    moving: boolean;
}

export class CinematicEditorTracker extends Component<ICinematicEditorTrackerProps, ICinematicEditorTrackerState> {
    public constructor(props: ICinematicEditorTrackerProps) {
        super(props);
