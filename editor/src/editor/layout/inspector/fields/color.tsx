    ...
    return (
        <div className="flex gap-2 items-center px-2">
            ...
            <div className="flex gap-2">
                ...
                <EditorInspectorNumberField object={props.object} property={`${props.property}.g`} onChange={(v) => handleChanelChange(v, "g")} />
                <EditorInspectorNumberField object={props.object} property={`${props.property}.b`} onChange={(v) => handleChanelChange(v, "b")} />
