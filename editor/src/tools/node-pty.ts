 ...
 */
export async function execNodePty(command: string, options: (IPtyForkOptions | IWindowsPtyForkOptions | (IPtyForkOptions & { interactive?: boolean }) | (IWindowsPtyForkOptions & { interactive?: boolean })) = {}): Promise<NodePtyInstance> {
	const id = randomUUID();
